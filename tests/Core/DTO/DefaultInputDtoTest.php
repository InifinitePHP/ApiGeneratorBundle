...
final class DefaultInputDtoTest extends TestCase
{
    private DefaultInputDto $dto;

    protected function setUp(): void
    {
        $this->dto = new DefaultInputDto();
    }
    ...
    {
        $dto1 = new DefaultInputDto();
        $dto1->id = 42;

        $dto2 = new DefaultInputDto();
        $dto2->id = 123;
    ...
    {
        $ref = new \ReflectionClass(DefaultInputDto::class);
